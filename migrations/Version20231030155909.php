 ...
 */
final class Version20231030155909 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE category_weapon (id INT AUTO_INCREMENT NOT NULL, name_category VARCHAR(50) NOT NULL, advantage INT NOT NULL, disadvantage INT NOT NULL, advantage_multiplicator DOUBLE PRECISION NOT NULL, disadvantage_multiplicator DOUBLE PRECISION NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE element (id INT AUTO_INCREMENT NOT NULL, name_element VARCHAR(50) NOT NULL, advantage INT NOT NULL, disadvantage INT NOT NULL, advantage_multiplicator DOUBLE PRECISION NOT NULL, disadvantage_multiplicator DOUBLE PRECISION NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE type_weapon (id INT AUTO_INCREMENT NOT NULL, name_type VARCHAR(50) NOT NULL, advantage INT NOT NULL, disadvantage INT NOT NULL, advantage_multiplicator DOUBLE PRECISION NOT NULL, disadvantage_multiplicator DOUBLE PRECISION NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
