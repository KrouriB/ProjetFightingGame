...
class JsonBuilder
{
    ...
    public function stockData(Equipe $equipe)
    {
        ...
        $personnage = ['Element' => $personnage->getElement()->getNameElement(), 'Type' => $personnage->getType()->getNameType(), 'Category' => $personnage->getCategory()->getNameCategory(), 'Attack' => $personnage->getAttack(), 'Magic' => $personnage->getMagic(), 'Life' => $personnage->getLife(),  'Energy' => $personnage->getEnergy(), 'Name' => $personnage->getName()];
        ...
        $accessory = ['NomStatAction' => $accessory->getTypeStatAction()->getNomStat(), 'NomTypeAction' => $accessory->getTypeStatAction()->getNomType(), 'StatAction' => $action, 'Defense' => $accessory->getDefense(), 'Resistance' => $accessory->getResistance(), 'Attack' => $accessory->getBonusAttack(), 'Magic' => $accessory->getBonusMagic(), 'Recovery' => $accessory->getEnergyRecovery(), 'turnWait' => $accessory->getWaitAction(), 'EnergyCost' => $accessory->getEnergyAction(), 'actionName' => $accessory->getNameAction()];
